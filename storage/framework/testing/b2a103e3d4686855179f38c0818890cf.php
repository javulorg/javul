            ...
            <table id="units_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="title_col">
                            <a
                                href="<?php echo url('units/'.$unitIDHashID->encode($unit->id).'/'.$unit->slug); ?>"><?php echo e($unit->name); ?></a>
                        </td>
                        <td class="last_reply_col">
                            ...
                            <a
                                href="<?php echo url('units/category='.strtolower($category_names[$index])); ?>"><?php echo e($category_names[$index]); ?></a>
...
<?php /**PATH /var/www/html/javul-staging/javul/resources/views/layout/v2/master/units.blade.php ENDPATH**/ ?>