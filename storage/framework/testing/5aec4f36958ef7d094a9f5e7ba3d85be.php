...
<div class="content_row">
    ...
    <div class="main_content">
        ...
        <?php if(in_array(auth()->user()->role, [0,2,3,4])): ?>
                ...
                <div class="table_block_body">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php if(\App\Models\SiteConfigs::task_status($assignedTask->status) == 'Assigned'): ?>
                            <tr>
                                <td class="title_col">
                                ...
                                <td class="type_col">
                                    <span class="colorLightGreen">
                                        <?php echo e(\App\Models\SiteConfigs::task_status($assignedTask->status)); ?>

                                    </span>
                                </td>

                                <td class="type_col">
                                    <a href="<?php echo e(url('notifications',$assignedTask->id)); ?>" class="btn btn-sm m-2"
                ...
                <div class="table_block_body">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="title_col">
                                    <a href="<?php echo e(url('tasks/' . $taskIDHashID->encode($inProgressTask->id) . '/' . $inProgressTask->slug)); ?>"
                                        title="edit">
                                ...
                                <td class="type_col">
                                    <form method="POST"
                                        action="<?php echo e(url('tasks/complete_task/' . $taskIDHashID->encode($inProgressTask->id))); ?>">
                                        <?php echo csrf_field(); ?>
                ...
                <div class="table_block_body">
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php if(count($underTask) > 0): ?>
                            

                            <?php $__currentLoopData = $underTask; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $completedTask): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="type_col">
                                    <span
                                        class="colorLightGreen"><?php echo e(\App\Models\SiteConfigs::task_status($completedTask->status)); ?></span>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="type_col">
                                    <span
                                        class="colorLightGreen"><?php echo e(\App\Models\SiteConfigs::task_status($myBid->task_status)); ?></span>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                            ...
                            <tr>
                                <td class="title_col">
                                    <a href="<?php echo url('tasks/'.$taskIDHashID->encode($valuationTask->task_id).'/'.$valuationTask->slug); ?>"
                                       ...
                                       <?php echo e($valuationTask->{"max(tasks.name)"}); ?>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/javul-staging/javul/resources/views/users/my_tasks.blade.php ENDPATH**/ ?>