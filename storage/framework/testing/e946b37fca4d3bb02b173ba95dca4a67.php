        ...
        <div class="content_block">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="type_col">
                                    ...
                                    <span
                                        class="colorLightGreen"><?php echo e(\App\Models\SiteConfigs::task_status($obj->status)); ?></span>
                                    <?php else: ?>
                                    <span
                                        class="colorLightGreen"><?php echo e(\App\Models\SiteConfigs::task_status($obj->status)); ?></span>
                                    <?php endif; ?>
            ...
            <div class="d-flex justify-content-between mt-2">
                ...
                <div class="pagination-right">
                    <a href="<?php echo url('tasks/add?unit='.$unitIDHashID->encode($unitData->id)); ?>"><img
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="type_col">
                                    <a
                                        href="<?php echo url('tasks/'.$taskIDHashID->encode($task->id) . '/' . $task->slug); ?>">
                                ...
                                <td class="title_col">
                                    <a
                                        href="<?php echo url('units/'.$unitIDHashID->encode($task->unit_id).'/'.\App\Models\Unit::getSlug($task->unit_id)); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/javul-staging/javul/resources/views/tasks/index.blade.php ENDPATH**/ ?>