...
<a href="<?php echo e(route('watchlist.store', ['userId' => $unitData->id , 'unitId' => $unitData->id, 'objective_id' => $objectiveObj->id])); ?>" class="edit_icon">
    <img src="<?php echo e(asset('v2/assets/img/eye.svg')); ?>" alt="">
</a>
            ...
            <div class="content_block">
                ...
                <div class="content_block_bottom">
                    <a href="<?php echo e(url('objectives/'.$unitIDHashID->encode($unitObj->id).'/add')); ?>"><img src="<?php echo e(asset('v2/assets/img/circle-plus.svg')); ?>" alt=""> Add New</a> <div class="separator"></div> <a href="#" class="see_more">See more</a>
                </div>
            </div>
            ...
            <div class="content_block">
                ...
                <div class="content_block_bottom">
                    <a href="<?php echo url('ideas/'.$unitIDHashID->encode($unitData->id).'/add'); ?>"><img src="<?php echo e(asset('v2/assets/img/circle-plus.svg')); ?>" alt=""> Add New</a> <div class="separator"></div> <a href="" class="see_more">See more</a>
                </div>
            </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul-new\javul\resources\views/objectives/view.blade.php ENDPATH**/ ?>