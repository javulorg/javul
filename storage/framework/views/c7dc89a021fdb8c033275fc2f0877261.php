        ...
        <div class="content_block">
                ...
                <div class="table_block_body">
                    ...
                    <table id="unit-objectives-table-id">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="<?php echo url('objectives/' . $objectiveIDHashID->encode($obj->id) . '/' . $obj->slug); ?>"
                                        title="edit">
                                        <?php echo e($obj->name); ?>
                                ...
                                <td class="text-center">
                                    <?php echo e(\App\Models\Task::getTaskCount('available', $obj->id)); ?></td>
                                <td class="text-center">
                                    <?php echo e(\App\Models\Task::getTaskCount('in-progress', $obj->id)); ?></td>
                                <td class="text-center">
                                    <?php echo e(\App\Models\Task::getTaskCount('completed', $obj->id)); ?></td>
                            </tr>
                        ...
                        <div class="mob_table_section">
                            ...
                            <div class="mob_table_row">
                                ...
                                <div class="mob_table_val text-center">
                                    <?php echo e(\App\Models\Task::getTaskCount('available', $obj->id)); ?>
            ...
            <div class="d-flex justify-content-between mt-2">
                ...
                <div class="pagination-right">
                    <a href="<?php echo url('objectives/' . $unitIDHashID->encode($unitData->id) . '/add'); ?>"><img
                ...
                <div class="table_block_body">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $pagination; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objective): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td class="title_col">
                                    <a
                                        href="<?php echo url('objectives/' . $objectiveIDHashID->encode($objective->id) . '/' . $objective->slug); ?>">
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/javul-staging/javul/resources/views/objectives/index.blade.php ENDPATH**/ ?>