...
<div class="content_row">
    ...
    <a href="<?php echo e(url('funds/donate/idea/' . $unitIDHashID->encode($idea->id))); ?>">Donate</a>
                            ...
                            <div class="objective_content_info_links">
                                ...
                                <a class="edit_icon watchlist-link-idea" href="javascript:void(0);"
                                    data-id="<?php echo e($idea->id); ?>" data-auth="<?php echo e($isLoggedIn ? '1' : '0'); ?>"
                                    data-url="<?php echo e(route('watchlistIdea.store', ['idea_id' => $idea->id])); ?>"
                                    id="idea-eye-link-<?php echo e($idea->id); ?>"
                                    style="<?php echo e($isIdeaWatched ? 'display: none;' : ''); ?>">
                                    <img src="<?php echo e(asset('v2/assets/img/eye.svg')); ?>" style="height: 20px; width: 20px;"
                                        alt="Watch">
                                </a>

                                
                                <a class="edit_icon unwatchlist-link-idea" href="javascript:void(0);"
                                    data-id="<?php echo e($idea->id); ?>" data-auth="<?php echo e($isLoggedIn ? '1' : '0'); ?>"
                                    data-url="<?php echo e(route('watchlistIdea.remove', ['idea_id' => $idea->id])); ?>"
                                    id="idea-eye-off-link-<?php echo e($idea->id); ?>"
                                    style="<?php echo e($isIdeaWatched ? '' : 'display: none;'); ?>">
                                ...
                                <a href="<?php echo e(route('idea_revisions', [$ideaHashId])); ?>" class="edit_icon">
                                    Revision History
                                </a>

                                
                                <div class="separat"></div>
                                <a href="<?php echo e(url('ideas/' . $ideaHashId . '/edit')); ?>" class="edit_icon">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="title_col">
                                    ...
                                    <span
                                        class="colorLightGreen"><?php echo e(\App\Models\SiteConfigs::task_status($idea->task->status)); ?></span>
                                    <?php else: ?>
                                    <span
                                        class="colorLightGreen"><?php echo e(\App\Models\SiteConfigs::task_status($idea->task->status)); ?></span>
                                    <?php endif; ?>
                            ...
                            <tr>
                                ...
                                <td class="type_col">
                                    <?php $status_class=''; $verified_by =''; $resolved_by ='';
                                                ...
                                                ?>
                                    <span class="<?php echo e($status_class); ?>"><?php echo e(ucfirst($idea->issue->status).$verified_by.
                                        $resolved_by); ?></span>
                                </td>
                                <td class="type_col">
                                    <a href="<?php echo url('userprofiles/'.$userIDHashID->encode($idea->issue->user_id).'/'.strtolower(str_replace(" ","
                                        _",App\Models\User::getUserName($idea->issue->user_id)))); ?>">
        ...
        <div class="content_block_comments">
            ...
            <div class="content_block_bottom">
                ...
                <div class="separator"></div> <a href="<?php echo e(url('ideas?unit=' . $unitData->id)); ?>" class="see_more"
