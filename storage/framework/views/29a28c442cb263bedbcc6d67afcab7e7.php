<?php $__env->startSection('title', 'Objective: View Revision'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-heading d-flex align-items-center">
                        ...
                        <h4 class="card-title" style="font-size: medium;">View Revision: <?php echo $objectiveObj->name; ?>

                            <input type="hidden" value="<?php echo e($objectiveObj->id); ?>" id="objective_id">
    ...
    <script>
        $(document).ready(function() {
            $('#thumb-up-btn').click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/objectives/upvote-edits")); ?>',
                    data: {
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul\resources\views/objectives/revison/view_revision.blade.php ENDPATH**/ ?>