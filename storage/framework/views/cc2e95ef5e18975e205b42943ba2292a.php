        ...
        <div class="panel panel-grey panel-default">
            ...
            <div class="panel-body list-group">
                <div class="list-group-item">
                    <form role="form" method="post" id="form_sample_2" action="<?php echo e(url('tasks')); ?>"
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <select
                                    <?php if(!empty($unitInfo) && !empty($task_objective_id)): ?> required name="objective_disabled" <?php else: ?> name="objective" <?php endif; ?>
                                    ...
                                    <?php if(count($objectiveObj) > 0): ?>
                                        <?php $__currentLoopData = $objectiveObj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $objective): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($objectiveIDHashID->encode($objective->id)); ?>"
                                                <?php if(!empty($taskObj) && $objective->id == $taskObj->objective_id): ?> selected=selected
                                                    <?php elseif(empty($taskObj) && $objective->id == $task_objective_id): ?>
                                                    selected=selected <?php endif; ?>>
                                                <?php echo e($objective->name); ?></option>
                        ...
                        <div class="row mt-4">
                                ...
                                <select name="task_skills[]" class="form-control" required data-live-search="true"
                                    ...
                                    <?php if(!empty($task_skills)): ?>
                                        <?php $__currentLoopData = $task_skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill_id => $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($skill_id); ?>"
                                                <?php if(!empty($exploded_task_list) && in_array($skill_id, $exploded_task_list)): ?> selected=selected <?php endif; ?>>
                                                <?php echo e($skill); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php endif; ?>
                                </select>
                            ...
                            <div
                                class="col-sm-4 form-group <?php echo e($errors->has('estimated_completion_time_start') ? ' has-error' : ''); ?>">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="estimated_completion_time_start"
                                        ...
                                        value="<?php echo e(!empty($taskObj) ? $taskObj->estimated_completion_time_start : old('estimated_completion_time_start')); ?>"
                            ...
                            <div
                                class="col-sm-4 form-group <?php echo e($errors->has('estimated_completion_time_end') ? ' has-error' : ''); ?>">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" id="estimated_completion_time_end"
                                        ...
                                        value="<?php echo e(!empty($taskObj) ? $taskObj->estimated_completion_time_end : old('estimated_completion_time_end')); ?>"
                                            ...
                                            <tbody>
                                                ...
                                                <?php if(!empty($taskDocumentsObj)): ?>
                                                    ...
                                                    <?php $__currentLoopData = $taskDocumentsObj; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <?php echo $__env->make('tasks.partials.task_document_listing', [
                                                            'document' => $document,
                                                            'taskObj' => $taskObj,
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul-new\javul\resources\views/tasks/create.blade.php ENDPATH**/ ?>