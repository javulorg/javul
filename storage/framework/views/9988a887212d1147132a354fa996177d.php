    ...
    <tr>
        <td style="padding:40px 0;">
            ...
            <table cellpadding="0" cellspacing="0" width="50%" border="0" align="center">
                ...
                <tr>
                    <td>
                        <a href="<?php echo e(url('/')); ?>" style="display:block; width:407px; height:100px; margin:0 auto 30px;">
                            <img src="<?php echo e(url('/assets/images/logo-email.png')); ?>" width="407" height="100" alt="" style="display:block; border:0; margin:0;">
                        </a>
                        <!-- begin wrapper -->
...
</html><?php /**PATH C:\xampp\htdocs\javul\resources\views/layout/email.blade.php ENDPATH**/ ?>