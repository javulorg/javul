<?php if((empty($unitObjForLeftBar) || \App\Models\Task::isUnitAdminOfTask($taskObj->id)) && (!empty($taskDocumentsObj) && count($taskDocumentsObj) < 10)): ?>
<tr>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\javul-new\javul\resources\views/tasks/partials/document_upload.blade.php ENDPATH**/ ?>