    ...
    <div class="main_content">
                        ...
                        <div class="objective_content_info">
                                ...
                                <div class="sidebar_block_content">
                                    ...
                                    <div class="sidebar_block_row">
                                        ...
                                        <div class="sidebar_block_right">
                                            ...
                                            <?php endif; ?>
                                            <?php echo e(ucfirst($issueObj->status == 1 ? 'Resolved' : 'Assigned To Task' .
                                            $verified_by)); ?>
                            ...
                            <div class="objective_content_info_links">
                                ...
                                <a href="javascript:void(0);" class="edit_icon watchlist-link-issue"
                                    data-id="<?php echo e($issueObj->id); ?>" data-auth="<?php echo e($isLoggedIn ? '1' : '0'); ?>"
                                    data-url="<?php echo e(route('watchlistIssue.store', ['issue_id' => $issueObj->id])); ?>"
                                ...
                                <a href="javascript:void(0);" class="edit_icon unwatchlist-link-issue"
                                    data-id="<?php echo e($issueObj->id); ?>" data-auth="<?php echo e($isLoggedIn ? '1' : '0'); ?>"
                                    data-url="<?php echo e(route('watchlistIssue.remove', ['issue_id' => $issueObj->id])); ?>"
                                ...
                                <a href="<?php echo e(route('issues_revison', [$issueIDHashID->encode($issueObj->id)])); ?>"
                                    class="edit_icon">
                                    Revision History
                                </a>
                                ...
                                <div class="separat"></div>
                                <a href="<?php echo e(url('issues/' . $issueIDHashID->encode($issueObj->id) . '/edit')); ?>"
                                    class="edit_icon">
        ...
        <div class="content_block">
            ...
            <div class="content_block_bottom">
                <a href="<?php echo url('objectives/'.$unitIDHashID->encode($unitObj->id).'/add'); ?>"><img
        ...
        <div class="content_block_comments">
            ...
            <div class="content_block_bottom">
                <a href="<?php echo url('issues/'.$unitIDHashID->encode($unit_activity_id).'/add'); ?>"><img
                        src="<?php echo e(asset('v2/assets/img/circle-plus.svg')); ?>" alt=""> Add
                    New</a>
                <div class="separator"></div> <a href="<?php echo e(url('issues?unit=' . $unitData->id)); ?>" class="see_more"
                    onclick="window.location.href=this.href; return true;" class="see_more">See more</a>
            </div>
        </div>
