<?php $__env->startSection('title', 'Objective: REVISION HISTORY'); ?>
          ...
          <div class="content_block">
            <div class="table_block table_block_objectives">
                <div class="table_block_head">
                    ...
                    View History: <?php echo $objectiveObj->name; ?>
                    ...
                    <table id="objectives-table-id">
                        ...
                        <?php $__currentLoopData = $revisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td class="title_col"><a href="<?php echo route('unit_objectives_view',[$objective_id,$value['id']]); ?>">View </a></td>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        var loc ='<?php echo url("objectives"); ?>/<?php echo $objective_id; ?>/diff';
        var slug ='';
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul\resources\views/objectives/revison/view.blade.php ENDPATH**/ ?>