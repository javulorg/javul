                        ...
                        <div class="objective_content_info">
                                    ...
                                    <div class="sidebar_block_row">
                                        ...
                                        <div class="sidebar_block_right">
                                            <label class="control-label"
                                                style="color: lightgreen;"><?php echo e(\App\Models\SiteConfigs::task_status($taskObj->status)); ?></label>
                                        </div>
                            ...
                            <div class="objective_content_info_links">
                                <a class="add_to_my_watchlist edit_icon" data-type="task"
                                    data-id="<?php echo e($taskIDHashID->encode($taskObj->id)); ?>"
                                    data-redirect="<?php echo e(url()->current()); ?>"><img src="<?php echo e(asset('v2/assets/img/eye.svg')); ?>"
                                        alt=""></a>
                                <div class="separat"></div>
                                <a href="<?php echo route('tasks_revison',[$taskIDHashID->encode($taskObj->id)]); ?>"
                                    class="edit_icon"> Revision History</a>
                                <div class="separat"></div>
                                <a href="<?php echo url('tasks/'.$taskIDHashID->encode($taskObj->id).'/edit'); ?>"
                                    class="edit_icon"><img src="<?php echo e(asset('v2/assets/img/pencil-create.svg')); ?>"
                                        alt=""></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 file_list" style="padding-left: 0px;">
                    ...
                    <ul style="list-style-type: decimal; padding-left:30px;">
                        ...
                        <?php $extension="docx"; ?>
                        <?php elseif($extension == "jpg" || $extension == "jpeg"): ?>
                        <?php $extension="jpeg"; ?>
                        <?php elseif($extension == "ppt" || $extension == "pptx"): ?>
                        <?php $extension="pptx"; ?>
                        <?php else: ?>
                        <?php $extension="file"; ?> <?php endif; ?>
                        <li>
            ...
            <div class="table_block table_block_objectives active">
                ...
                <div class="table_block_txt">
                    <a style="font-weight: normal;" class="no-decoration"
                        href="<?php echo url('objectives/'.$objectiveIDHashID->encode($taskObj->objective->id).'/'.$objSlug ); ?>">
        ...
        <div class="content_block mt-3">
            <div class="row">
                <div class="col-sm-12" style="padding:20px 20px 10px 30px;">
                    ...
                    <?php if($authUserObj->role == 0): ?>
                    <form role="form" method="post"
                        action="<?php echo e(url('tasks/complete_task/' . $taskIDHashID->encode($taskObj->id))); ?>"
                        ...
                        strtolower($completeObj->first_name.'_'.$completeObj->last_name)); ?>">
                            ...
                            <div class="col-sm-12"><?php echo $completeObj->comments; ?></div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <span>
                                    <a href="<?php echo url($doc->file_path); ?>" target="_blank"><?php echo e($doc->file_name); ?></a>
                                </span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <?php endif; ?>
                    ...
                    <form id="taskCompleteForm" role="form" method="post" action="<?php echo e(url('tasks/mark_task_complete/' . $taskIDHashID->encode($taskObj->id))); ?>" novalidate
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div style="display: inline-block;padding-left: 10px;">
                                    <a
                                        href="<?php echo url('userprofiles/' . $userIDHashID->encode($completeObj->user_id) . '/' . strtolower($completeObj->first_name . '_' . $completeObj->last_name)); ?>">
                                        <?php echo e($completeObj->first_name . ' ' . $completeObj->last_name); ?>
                            ...
                            <div class="col-sm-12">
                                <?php $__currentLoopData = $taskCompleteDocs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <span><a href="<?php echo url($doc->file_path); ?>" target="_blank"><?php echo e($doc->file_name); ?></a></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                            <?php endif; ?>
                        </div>
