    ...
    <div class="panel panel-grey panel-default">
        ...
        <div class="panel-body list-group">
            <div class="list-group-item">
                <form role="form" method="post" id="task_form" action="<?php echo e(url('tasks/'. $taskHashId)); ?>"
                    enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('put'); ?>

                    <input type="hidden" id="current_task_status" value="<?php echo e($taskObj->status); ?>">
                    <input type="hidden" id="auth_user" value="<?php echo e(auth()->user()->role); ?>">
                    <div class="row">
                        <div class="col-md-12 form-group">
                            <label class="control-label">Task Name <span class="text-danger">*</span></label>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <select <?php if(!empty($unitInfo) && !empty($task_objective_id)): ?> name="objective_disabled" <?php else: ?>
                                name="objective" <?php endif; ?> id="objective" class="form-control selectpicker"
                                ...
                                <option value="<?php echo e($objectiveIDHashID->encode($objective->id)); ?>" <?php if(!empty($taskObj) &&
                                    $objective->id == $taskObj->objective_id): ?>
                                    selected=selected
                        ...
                        <div class="col-sm-12 mt-3 form-group">
                            ...
                            <select class="form-select" name="idea_id" id="idea_id">
                                ...
                                <option value="<?php echo e($idea->id); ?>" <?php echo e($idea->id == $taskObj->idea_id ? 'selected' : ''); ?>><?php echo e($idea->title); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-4  form-group <?php echo e($errors->has('task_skills') ? ' has-error' : ''); ?>">
                            ...
                            <select name="task_skills[]" class="form-control" data-live-search="true" id="task_skills"
                                multiple>
                        ...
                        <div
                            class="col-sm-4 mt-1 mb-2 form-group <?php echo e($errors->has('estimated_completion_time_start') ? ' has-error' : ''); ?>">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="estimated_completion_time_start"
                                    ...
                                    value="<?php echo e((!empty($taskObj))?
                        ...
                        <div
                            class="col-sm-4 mt-1 mb-2 form-group <?php echo e($errors->has('estimated_completion_time_end') ? ' has-error' : ''); ?>">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" id="estimated_completion_time_end"
                                    ...
                                    value="<?php echo e((!empty($taskObj))?
                                                                                ...
                                                                                old('estimated_completion_time_end')); ?>" class="form-control datetimepicker"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-6 mt-1">
                            <div class="form-group">
                                <?php
                                $adminRoles = [1, 2, 3]; // admin roles
                                $allStatuses = \App\Models\SiteConfigs::task_status();
                                $visibleStatuses = [];

                                if (in_array(auth()->user()->role, $adminRoles)) {
                                $visibleStatuses = $allStatuses;
                                } else {
                                // Show only 'draft' and 'waiting_for_approval' for non-admins
                                $visibleStatuses = collect($allStatuses)->only(['draft', 'waiting_for_approval']);
                                }
                                ?>

                                <label class="control-label">Status</label>
                                <select name="task_status" class="form-control" id="task_status">
                                    <?php $__currentLoopData = $visibleStatuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e($taskObj->status == $key ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
                                ...
                                <div class="table-responsive overflow-hidden">
                                    <table class="documents table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php if(empty($taskObj) || ($taskObj->status == "draft")): ?>
