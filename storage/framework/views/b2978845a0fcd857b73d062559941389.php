...
<div class="content_block mt-3">
    <div class="table_block table_block_tasks">
        ...
        <div class="table_block_body">
            <table>
                ...
                <tbody>
                <?php if(isset($topics[2]) > 0): ?>
                    <?php $__currentLoopData = $topics[2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="title_col">
                ...
                <div class="mob_table d-sm-none d-block">
                    <?php if(isset($topics[2]) && count($topics[2]) > 0): ?>
                        <?php $__currentLoopData = $topics[2]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $topic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="content_block_bottom">
        <a href="<?php echo url('forum/create').'/'.$unit_id.'/'.'tasks'; ?>"><img src="<?php echo e(asset('v2/assets/img/circle-plus.svg')); ?>" alt=""> Add New</a>
    </div>
</div>
<?php /**PATH /var/www/html/javul-staging/javul/resources/views/forum/forum-partials/tasks.blade.php ENDPATH**/ ?>