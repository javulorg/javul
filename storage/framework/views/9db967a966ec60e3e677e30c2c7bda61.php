        ...
        <div class="panel panel-grey panel-default">
            ...
            <div class="panel-body list-group">
                <div class="list-group-item">
                    <form role="form" method="post" id="form_sample_2" action="<?php echo e(url('tasks')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-sm-12 mt-1 mb-2 form-group">
                                <label class="control-label">Task Name</label>
                                <div class="input-icon right">
                                    <input type="text" name="task_name" id="task_name" value="<?php echo e((!empty($taskObj))? $taskObj->name : old('task_name')); ?>" class="form-control" placeholder="Task Name">
                                </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <select <?php if(!empty($unitInfo) && !empty($task_objective_id)): ?> name="objective_disabled" <?php else: ?> name="objective" <?php endif; ?> id="objective"
                                ...
                                <?php if(!empty($unitInfo) && !empty($task_objective_id)): ?>
                                    <input type="hidden" name="objective" value="<?php echo e($objectiveIDHashID->encode($task_objective_id)); ?>"/>
                                <?php endif; ?>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-sm-4 form-group <?php echo e($errors->has('estimated_completion_time_start') ? ' has-error' : ''); ?>">
                                <label class="control-label">Estimated Completion Time From</label>
                                <div class="input-group mb-3">
                                    <input type="text" id="estimated_completion_time_start" name="estimated_completion_time_start" value="<?php echo e((!empty($taskObj))?
                            ...
                            <div class="col-sm-4 form-group <?php echo e($errors->has('estimated_completion_time_end') ? ' has-error' : ''); ?>">
                                <label class="control-label">Estimated Completion Time To</label>
                                <div class="input-group mb-3">
                                    <input type="text" id="estimated_completion_time_end" name="estimated_completion_time_end" value="<?php echo e((!empty($taskObj))?
                        ...
                        <div class="row mt-2">
                            <div class="col-sm-4 form-group">
                                <label class="control-label">Compensation <span
                                        class="text-danger">*</span></label>
                                <div class="input-group mb-3">
                                        <input type="text" id="compensation" name="compensation" value="<?php echo e((!empty($taskObj))? $taskObj->compensation : old('compensation')); ?>"
                        ...
                        <div class="row justify-content-center mt-3">
                            <div class="col-md-6 col-lg-4">
                                <button class="btn btn-secondary btn-block" type="submit" id="create_unit">
                                    <i class="fa fa-plus"></i> <span class="plus_text">Create Task</span>
                                </button>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul\resources\views/objectives/tasks/create.blade.php ENDPATH**/ ?>