<table class="table table-striped">
    ...
    <tr>
        ...
        <td>
            <input <?php if(!empty($alertsObj) && $alertsObj->forum_replies == 1): ?> checked  <?php endif; ?> data-toggle="toggle"
                   type="checkbox"
    ...
    <tr>
        ...
        <td>
            <input <?php if(!empty($alertsObj) && $alertsObj->watched_items == 1): ?> checked  <?php endif; ?> data-toggle="toggle"
                   type="checkbox"
    ...
    <tr>
        ...
        <td>
            <input <?php if(!empty($alertsObj) && $alertsObj->inbox == 1): ?> checked  <?php endif; ?> data-toggle="toggle"
                   type="checkbox"
                   name="alert_inbox"
                   data-onstyle="success"
                   data-offstyle="danger"
    ...
    <tr>
        ...
        <td>
            <input <?php if(!empty($alertsObj) && $alertsObj->fund_received == 1): ?> checked  <?php endif; ?> data-toggle="toggle"
                   type="checkbox"
    ...
    <tr>
        ...
        <td>
            <input <?php if(!empty($alertsObj) && $alertsObj->task_management == 1): ?> checked  <?php endif; ?> data-toggle="toggle"
                   type="checkbox"
