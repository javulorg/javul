<?php $__env->startSection('title', 'Task: REVISION HISTORY'); ?>
            ...
            <div class="content_block">
                <div class="table_block table_block_tasks">
                    <div class="table_block_head">
                        ...
                        View History: <?php echo $taskObj->name; ?>
                        ...
                        <table>
                            ...
                            <?php $__currentLoopData = $revisions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <tr>
                                    ...
                                    <td class="title_col"><a href="<?php echo route('unit_tasks_view',[$task_id,$value['id']]); ?>">View</a></td>
...
<?php $__env->startSection('scripts'); ?>
    <script type="text/javascript">
        ...
        var loc ='<?php echo url("tasks"); ?>/<?php echo $task_id; ?>/diff';
        var slug ='';
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul\resources\views/tasks/revison/view.blade.php ENDPATH**/ ?>