                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="unit_category[]" id="unit_category" multiple>
                                    ...
                                    <option value="<?php echo e($id); ?>" <?php if(!empty($edit_unit_category) &&
                                        in_array($id,$edit_unit_category)): ?> selected=selected <?php endif; ?>><?php echo e($val); ?></option>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="unit_type" id="unitType">
                                    ...
                                    <option value="2" <?php echo e($unitObj->unit_type == 2 ? 'selected' : ''); ?>>People’s
                                        Government</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3" id="product-service-div">
                            <div class="form-group col-sm-4" id="productNameDiv">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($unitObj->product_name); ?>"
                            ...
                            <div class="form-group col-sm-4" id="serviceNameDiv">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($unitObj->service_name); ?>"
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <select class="form-control" id="businessModel" name="business_model">
                                    ...
                                    <option value="1" <?php echo e($unitObj->business_model == 1 ? 'selected' : ''); ?>>Corporate
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-sm-4 mt-3" id="operationalGradeDiv">
                                <label for="operationalGrade">Operational Grade <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="<?php echo e($unitObj->operational_grade); ?>"
                            ...
                            <div class="form-group col-sm-4 mt-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo e($unitObj->company); ?>" id="company"
                        ...
                        <div class="col-sm-4 mt-3 form-group">
                            ...
                            <select class="form-control" name="city" id="city" <?php if(!empty($unitObj) &&
                            ...
                            <input type="hidden" name="empty_city_state_name" id="empty_city_state_name"
                                <?php if(!empty($state_name_as_city_for_field)): ?>
                                value="<?php echo e($unitObj->state_id_for_city_not_exits); ?>" <?php endif; ?> />
                        ...
                        <div class="col-sm-12 mt-3 form-group">
                            ...
                            <input class="form-control" name="comment" <?php if(!empty($unitObj) &&
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input data-toggle="toggle" data-on="Active" data-off="Disabled" type="checkbox"
                                name="status" <?php if(!empty($unitObj) && $unitObj->status == "active"): ?> checked
                            <?php elseif(empty($unitObj)): ?> checked <?php endif; ?>>
                        </div>
                        <?php endif; ?>
