        ...
        <div class="panel panel-grey panel-default col-md-9">
            ...
            <div class="panel-body list-group">
                <div class="list-group-item">
                    <form role="form" method="post"  action="<?php echo e(url('site-admin/users/store')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul\resources\views/site-admins/users/store.blade.php ENDPATH**/ ?>