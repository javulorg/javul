...
<?php $__env->startSection('content'); ?>
    <div class="col-md-12 col-sm-12">
        <div class="card mb-6">
            <div class="card-body overflow-auto">
                ...
                <div class="row">
                    <?php echo $__env->make('users.user-account-partials.profile-summery', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('users.user-account-partials.profile-picture', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="tab-content" id="myTabContent">
        <div class="tab-pane fade show active" id="personal_info" role="tabpanel" aria-labelledby="personal-info-tab">
            <?php echo $__env->make('users.user-account-partials.personal-info', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="tab-pane fade" id="withdraw_amount" role="tabpanel" aria-labelledby="withdraw-amount-tab">
            <?php echo $__env->make('users.user-account-partials.withdraw-amount', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="tab-pane fade" id="withdrawal_list" role="tabpanel" aria-labelledby="withdrawal-list-tab">
            <?php echo $__env->make('users.user-account-partials.withdraw-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>

        <div class="tab-pane fade" id="account_settings" role="tabpanel" aria-labelledby="account-settings-tab">
            <?php echo $__env->make('users.user-account-partials.account-settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/javul-staging/javul/resources/views/users/my_account.blade.php ENDPATH**/ ?>