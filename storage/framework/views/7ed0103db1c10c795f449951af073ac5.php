...
alt="Watched" id="eye-off-icon-<?php echo e($objectiveObj->id); ?>">
                                    ...
                                    <div class="separat"></div>
                                    <a href="<?php echo url('objectives/' . $objectiveIDHashID->encode($objectiveObj->id) . '/edit'); ?>" class="edit_icon"><img
            ...
            <div class="content_block">
                ...
                <div class="content_block_bottom">
                    ...
                    <div class="separator"></div>
                    <a href="<?php echo e(url('objectives?unit=' . $unitData->id)); ?>" class="see_more" onclick="window.location.href=this.href; return true;">See more</a>
            ...
            <div class="content_block">
                <div class="table_block table_block_objective">
                    <div class="table_block_head">
                        <div class="table_block_icon">
                            <img src="<?php echo e(asset('v2/assets/img/Users_Two_Rounded.svg')); ?>" alt=""
                                class="img-fluid">
                        </div>
                        Child Objectives
                        <div class="arrow">
                ...
                <div class="content_block_bottom">
                    <a href="<?php echo e(url('objectives/' . $unitIDHashID->encode($unitObj->id) . '/add')); ?>"><img
                            src="<?php echo e(asset('v2/assets/img/circle-plus.svg')); ?>" alt=""> Add New</a>
                            <div class="separator"></div> <a href="<?php echo e(url('objectives?unit=' . $unitData->id)); ?>" class="see_more" onclick="window.location.href=this.href; return true;">See more</a>
            ...
            <div class="content_block">
                <div class="table_block table_block_ideas">
                    <div class="table_block_head">
                        <div class="table_block_icon">
                            <img src="<?php echo e(asset('v2/assets/img/humbleicons_bulb.svg')); ?>" alt=""
                                class="img-fluid">
                        </div>
                        Ideas
                        <div class="arrow">
            ...
            <div class="content_block_comments">
                ...
                <div class="content_block_bottom">
                    <a href="<?php echo e(url('objectives/' . $unitIDHashID->encode($unitObj->id) . '/add')); ?>"><img src="<?php echo e(asset('v2/assets/img/circle-plus.svg')); ?>" alt=""> Add
                        New</a>
                        <div class="separator"></div>    <a href="<?php echo e(url('objectives?unit=' . $unitData->id)); ?>" class="see_more" onclick="window.location.href=this.href; return true;">See more</a>
                    </div>
            </div>
