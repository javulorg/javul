<?php $__env->startSection('title', 'Idea: View Revision'); ?>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-heading d-flex align-items-center">
                        ...
                        <h4 class="card-title" style="font-size: medium;">View Revision: <?php echo $idea->name; ?>

                            <input type="hidden" value="<?php echo e($revisions->id); ?>" id="revision_id">
                            <input type="hidden" value="<?php echo e($idea->id); ?>" id="idea_id">
    ...
    <script>
        $(document).ready(function() {
            $('#thumb-up-btn').click(function(e) {
                e.preventDefault();
                var ideaId = $('#idea_id').val();
                var revisionId = $('#revision_id').val();
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/ideas/upvote-edits")); ?>',
                    data: {
                        ideaId   : ideaId,
                    ...
                    success: function(response) {
                        Swal.fire({
                            icon: 'success',
                            title: 'Success!',
                            text: 'Idea likes updated successfully',
                    ...
                    error: function(xhr, status, error) {
                        Swal.fire({
                            icon: 'warning',
                            title: 'Warning!',
                            text: 'You have already upvoted this idea',
                            timer: 2000 // Close after 2 seconds
                        });
                    }
                });
...
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\javul\resources\views/ideas/revision/view_revision.blade.php ENDPATH**/ ?>