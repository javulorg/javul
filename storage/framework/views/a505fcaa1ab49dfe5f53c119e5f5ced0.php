                ...
                <form role="form" method="post" id="form_sample_2" action="<?php echo e(url('units')); ?>">
                        ...
                        <div class="col-sm-4 mt-3 form-group">
                            ...
                            <select class="form-control" required name="city" id="city"
                                ...
                                <option value="<?php echo e($state_name_as_city_for_field->id); ?>" selected>
                                    <?php echo e($state_name_as_city_for_field->name); ?>
                    ...
                    <div class="col-sm-12 mt-3 form-group">
                        ...
                        <textarea class="form-control" id="description" name="description">
                                 <?php if(!empty($unitObj)): ?> <?php echo e($unitObj->description); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/javul-staging/javul/resources/views/units/create.blade.php ENDPATH**/ ?>