                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-select"  name="unit_type" id="unitType">
                                        ...
                                        <option value="2" {{ $unitObj->unit_type == 2 ? 'selected' : '' }}>People’s Government</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3" id="product-service-div">
                                <div class="form-group col-sm-4" id="productNameDiv">
                                    ...
                                    <input type="text" class="form-control" value="{{ $unitObj->product_name }}" id="productName" placeholder="Product Name" name="product_name">
                                </div>

                                <div class="form-group col-sm-4" id="serviceNameDiv">
                                    <label for="serviceName">Service Name <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $unitObj->service_name }}" id="serviceName" placeholder="Service Name" name="service_name">
                                </div>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <select class="form-control" id="businessModel" name="business_model">
                                        ...
                                        <option value="0" {{ $unitObj->business_model == 0 ? 'selected' : '' }}>Community-owned</option>
                                        <option value="1" {{ $unitObj->business_model == 1 ? 'selected' : '' }}>Corporate</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group col-sm-4 mt-3" id="operationalGradeDiv">
                                    ...
                                    <input type="text" class="form-control" value="{{ $unitObj->operational_grade }}" id="operationalGrade" placeholder="Enter Operational Grade" name="operational_grade">
                                </div>

                                <!-- Company -->
                                <div class="form-group col-sm-4 mt-3">
                                    <label for="company">Company <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="{{ $unitObj->company }}" id="company" placeholder="Enter Company Name" name="company">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-4 mt-3" id="scopeDiv">
                                ...
                                <select class="form-control" id="scope" name="scope">
                                    ...
                                    <option value="0" {{ $unitObj->scope == 0 && $unitObj->scope != null ? 'selected' : '' }}>City</option>
                                    <option value="1" {{ $unitObj->scope == 1 && $unitObj->scope != null ? 'selected' : '' }}>County</option>
                                    <option value="2" {{ $unitObj->scope == 2 && $unitObj->scope != null ? 'selected' : '' }}>State</option>
                                    <option value="3" {{ $unitObj->scope == 3 && $unitObj->scope != null ? 'selected' : '' }}>National</option>
                                    <option value="4" {{ $unitObj->scope == 4 && $unitObj->scope != null ? 'selected' : '' }}>International</option>
                                </select>
                            </div>
