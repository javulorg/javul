                    ...
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="input-icon right">
                                <input type="text" name="unit_name"
                                    value="{{ (!empty($unitObj))? $unitObj->name : old('unit_name') }}"
                                    class="form-control" placeholder="{{ __('messages.unit_name') }}" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="unit_category[]" id="unit_category" multiple>
                                    ...
                                    <option value="{{$id}}" @if(!empty($edit_unit_category) &&
                                        in_array($id,$edit_unit_category)) selected=selected @endif>{{$val}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <select class="form-select" name="unit_type" id="unitType">
                                    ...
                                    <option value="0" {{ $unitObj->unit_type == 0 ? 'selected' : '' }}>Product</option>
                                    <option value="1" {{ $unitObj->unit_type == 1 ? 'selected' : '' }}>Service</option>
                                    <option value="2" {{ $unitObj->unit_type == 2 ? 'selected' : '' }}>People’s
                                        Government</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3" id="product-service-div">
                            <div class="form-group col-sm-4" id="productNameDiv">
                                ...
                                <input type="text" class="form-control" value="{{ $unitObj->product_name }}"
                                    id="productName" placeholder="Product Name" name="product_name">
                            </div>

                            <div class="form-group col-sm-4" id="serviceNameDiv">
                                <label for="serviceName">Service Name <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="{{ $unitObj->service_name }}"
                                    id="serviceName" placeholder="Service Name" name="service_name">
                            </div>
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <select class="form-control" id="businessModel" name="business_model">
                                    ...
                                    <option value="0" {{ $unitObj->business_model == 0 ? 'selected' : ''
                                        }}>Community-owned</option>
                                    <option value="1" {{ $unitObj->business_model == 1 ? 'selected' : '' }}>Corporate
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="form-group col-sm-4 mt-3" id="operationalGradeDiv">
                                <label for="operationalGrade">Operational Grade <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" value="{{ $unitObj->operational_grade }}"
                                    id="operationalGrade" placeholder="Enter Operational Grade"
                            ...
                            <div class="form-group col-sm-4 mt-3">
                                ...
                                <input type="text" class="form-control" value="{{ $unitObj->company }}" id="company"
                        ...
                        <div class="form-group col-sm-4 mt-3" id="scopeDiv">
                            ...
                            <select class="form-control" id="scope" name="scope">
                                ...
                                <option value="0" {{ $unitObj->scope == 0 && $unitObj->scope != null ? 'selected' : ''
                                    }}>City</option>
                                <option value="1" {{ $unitObj->scope == 1 && $unitObj->scope != null ? 'selected' : ''
                                    }}>County</option>
                                <option value="2" {{ $unitObj->scope == 2 && $unitObj->scope != null ? 'selected' : ''
                                    }}>State</option>
                                <option value="3" {{ $unitObj->scope == 3 && $unitObj->scope != null ? 'selected' : ''
                                    }}>National</option>
                                <option value="4" {{ $unitObj->scope == 4 && $unitObj->scope != null ? 'selected' : ''
                        ...
                        <div class="col-sm-4 mt-3 form-group">
                            ...
                            <select class="form-control" data-live-search="true" name="state" id="state"
                                @if(!empty($unitObj) && $unitObj->country_id == "global") disabled @endif>
                                @if(!empty($unitObj))
                            ...
                            <span class="states_loader location_loader" style="display: none"><img
                                    src="{!! url('assets/images/small_loader.gif') !!}" /></span>
                        </div>

                        <div class="col-sm-4 mt-3 form-group">
                            <label class="control-label">City<span class="text-danger">*</span></label>
                            <select class="form-control" name="city" id="city" @if(!empty($unitObj) &&
                                $unitObj->country_id == "global")
                                disabled @endif>
                                @if(!empty($unitObj))
                                @if(!empty($state_name_as_city_for_field))
                                <option value="{{$state_name_as_city_for_field->id}}" selected>
                                    {{$state_name_as_city_for_field->name}}</option>
                                @else
                            ...
                            <input type="hidden" name="empty_city_state_name" id="empty_city_state_name"
                                @if(!empty($state_name_as_city_for_field))
                                value="{{$unitObj->state_id_for_city_not_exits}}" @endif />
                            <span class="cities_loader location_loader" style="display: none"><img
                                    src="{!! url('assets/images/small_loader.gif') !!}" />
                            </span>
                        </div>

                        <div class="col-sm-4 mt-3 form-group">
                            <label class="control-label">{{ __('messages.unit_credibility') }}<span
                                    class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-12 mt-3 form-group">
                            ...
                            <input class="form-control" name="comment" @if(!empty($unitObj) &&
                                !empty($unitObj->comment))
                        ...
                        <div class="col-sm-4 form-group">
                            ...
                            <input data-toggle="toggle" data-on="Active" data-off="Disabled" type="checkbox"
                                name="status" @if(!empty($unitObj) && $unitObj->status == "active") checked
                            @elseif(empty($unitObj)) checked @endif>
                        </div>
                        @endif
...
<script>
    ...
    function toggleFields() {
        var selectedOption = $("#unitType").val();
    ...
    // Also call when dropdown value changes
    $("#unitType").change(function () {
        toggleFields();
    });
});
