                                                    ...
                                                    <tr>
                                                        <td>
                                                            @if($p_skill->action_type == "delete")
                                                                {{\App\Models\JobSkill::getName($p_skill->job_skill_id)}}
                                                            @else
                                                                {{$p_skill->skill_name}}
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            @if($p_category->action_type == "delete")
                                                                {{\App\Models\UnitCategory::getName($p_category->unit_category_id)}}
                                                            @else
                                                                {{$p_category->name}}
                                                            @endif
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            @if($areaOfInterest->action_type == "delete")
                                                                {{\App\Models\AreaOfInterest::getName($areaOfInterest->area_of_interest_id)}}
                                                            @else
