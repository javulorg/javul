    ...
    <div class="container">
        <ul class="nav justify-content-center flex-md-row flex-column">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#">Report a Concern</a>
            </li>
            <li class="nav-item">
    ...
    <script src="{{ asset('v2/summernote/summernote.min.js') }}"></script>
    <script src="{{ asset('v2/tooltipster/dist/js/tooltipster.bundle.min.js') }}"></script>
    <script src="{{ asset('v2/jquery/jquery-validation/dist/jquery.validate.min.js') }}"></script>
    <script src="{{ asset('v2/jquery/jquery-validation/dist/additional-methods.min.js') }}"></script>
...
{{--    <script src="{{ asset('v2/ckeditor5/ckeditor.js') }}"></script>--}}
    <script src="{{ asset('v2/toastr-options.js') }}"></script>
