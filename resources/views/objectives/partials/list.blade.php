                            ...
                            @if(count($objectiveObj) > 0)
                                @foreach($objectiveObj as $obj)
                                    <tr>
                                        ...
                                        <td>{{\App\Models\Task::getTaskCount('available',$obj->id)}}</td>
                                        <td>{{\App\Models\Task::getTaskCount('in-progress',$obj->id)}}</td>
                                        <td>{{\App\Models\Task::getTaskCount('completed',$obj->id)}}</td>
                                    </tr>
                                @endforeach
                            @else
                                <tr>
