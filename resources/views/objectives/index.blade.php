...
<div class="content_row">
        ...
        <div class="content_block">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    {{ \App\Models\Task::getTaskCount('available', $obj->id) }}</td>
                                <td class="text-center">
                                    {{ \App\Models\Task::getTaskCount('in-progress', $obj->id) }}</td>
                                <td class="text-center">
                                    {{ \App\Models\Task::getTaskCount('completed', $obj->id) }}</td>
                            </tr>
                            @endforeach
                            @else
                            <tr>
            ...
            <div class="d-flex justify-content-between mt-2">
                ...
                <div class="pagination-right">
                    <a href="{!! url('objectives/' . $unitIDHashID->encode($unitData->id) . '/add') !!}"><img
                ...
                <div class="table_block_body">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            @foreach ($pagination as $objective)
                            <tr>
                                <td class="title_col">
                                    <a
                                        href="{!! url('objectives/' . $objectiveIDHashID->encode($objective->id) . '/' . $objective->slug) !!}">
                                        {{ $objective->name }}
                                    </a>
                                </td>
    ...
    {{-- <div class="d-flex justify-content-between mt-2">
        ...
        <div class="pagination-right">
            <a href="{{ url('objectives/create') }}"><img src="{{ asset('v2/assets/img/circle-plus.svg') }}" alt=""> Add
                New</a>
        </div>
    </div> --}}
</div>
