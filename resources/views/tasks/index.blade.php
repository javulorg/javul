        ...
        <div class="content_block">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="type_col">
                                    @if($obj->status == "draft")
                                    <span
                                        class="colorLightGreen">{{\App\Models\SiteConfigs::task_status($obj->status)}}</span>
                                    @else
                                    <span
                                        class="colorLightGreen">{{\App\Models\SiteConfigs::task_status($obj->status)}}</span>
                                    @endif
                    ...
                    <div class="mob_table d-sm-none d-block">
                        ...
                        <div class="mob_table_section">
                            ...
                            <div class="mob_table_row">
                                ...
                                <div class="mob_table_val">
                                    <span class="colorLightGreen">{{ \App\Models\SiteConfigs::task_status($obj->status)
                                        }}</span>
                                </div>
                            </div>
            ...
            <div class="d-flex justify-content-between mt-2">
                ...
                <div class="pagination-right">
                    <a href="{!! url('tasks/add?unit='.$unitIDHashID->encode($unitData->id)) !!}"><img
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="type_col">
                                    <a
                                        href="{!! url('tasks/'.$taskIDHashID->encode($task->id) . '/' . $task->slug) !!}">
                                        {{$task->name}}
                                    </a>
                                </td>
                                <td class="title_col">
