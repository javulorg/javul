    ...
    <div class="panel panel-grey panel-default">
        ...
        <div class="panel-body list-group">
            <div class="list-group-item">
                <form role="form" method="post" id="task_form" action="{{ url('tasks/'. $taskHashId) }}"
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-sm-12 form-group">
                            ...
                            <select @if(!empty($unitInfo) && !empty($task_objective_id)) name="objective_disabled" @else
                                name="objective" @endif id="objective" class="form-control selectpicker"
                                data-live-search="true">
                                @if(count($objectiveObj) > 0)
                                @foreach($objectiveObj as $objective)
                                <option value="{{$objectiveIDHashID->encode($objective->id)}}" @if(!empty($taskObj) &&
                        ...
                        <div class="col-sm-12 mt-3 form-group">
                            ...
                            <select class="form-select" name="idea_id" id="idea_id">
                                ...
                                <option value="{{ $idea->id }}" {{ $idea->id == $taskObj->idea_id ? 'selected' : ''
                                    }}>{{ $idea->title }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="row mt-3">
                        ...
                        <div
                            class="col-sm-4 mt-1 mb-2 form-group {{ $errors->has('estimated_completion_time_start') ? ' has-error' : '' }}">
                        ...
                        <div
                            class="col-sm-4 mt-1 mb-2 form-group {{ $errors->has('estimated_completion_time_end') ? ' has-error' : '' }}">
                    ...
                    <div class="row mt-3">
                        ...
                        {{-- <div class="col-sm-6 mt-1">
                            <div class="form-group">
                                ...
                                <select name="task_status" class="form-control" id="task_status">
                                    ...
                                    <option value="{{ $index }}" {{ $taskObj->status == $index ? 'selected' : '' }}>
                                        {{ $status }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-sm-6 mt-1">
                            <div class="form-group">
                                ...
                                <label class="control-label">Status</label>
                                <select name="task_status" class="form-control" id="task_status">
                                    @foreach($visibleStatuses as $key => $label)
                                    <option value="{{ $key }}" {{ $taskObj->status == $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                    @endforeach
                                </select>
