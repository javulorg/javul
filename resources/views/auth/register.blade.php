...
{{--    <div class="card">--}}
{{--        <div class="card-body">--}}
{{--            <h2 class="card-title">{{ __('messages.please_signup') }}</h2>--}}
...
{{--                    <div class="col-md-8 mb-2">--}}
{{--                        <label for="first_name" class="form-label">{{ __('messages.enter_firstname') }}*</label>--}}
...
{{--                    <div class="col-md-8 mb-2">--}}
{{--                        <label for="last_name" class="form-label">{{ __('messages.enter_lastname') }}*</label>--}}
...
{{--                    <div class="col-md-8 mb-2">--}}
{{--                        <label for="password" class="form-label">{{ __('messages.enter_password') }}*</label>--}}
            ...
            <div class="row justify-content-center">
                <div class="form-group mb-2">
                    ...
                    @if ($errors->has('user_name'))
                        <span class="help-block">
                        <strong>{{ $errors->first('user_name') }}</strong>
                    </span>@elseif($errors->has('username_duplicate'))
                                <span class="help-block">
                      <strong>{{ $errors->first('username_duplicate') }}</strong>
                    </span>
                    @endif
