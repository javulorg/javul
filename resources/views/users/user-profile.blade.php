                ...
                <div class="user-header">
                    ...
                    @if(!empty($job_skills))
                        @foreach($job_skills as $skill)
                            <span class="label label-info tags">{{\App\Models\JobSkill::getName($skill)}}</span>
                        @endforeach
                    @endif
                </div>
                <div class="user-header">
                    ...
                    @if(!empty($area_of_interest))
                        @foreach($area_of_interest as $interest)
                            <span class="label label-info tags">{{\App\Models\AreaOfInterest::getName($interest)}}</span>
                        @endforeach
                    @endif
                </div>
