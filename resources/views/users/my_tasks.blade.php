                            ...
                            @if(count($myAssignedTask) > 0)
                                @foreach($myAssignedTask as $assigned_task)
                                    <tr>
                                        ...
                                        <td>{{\App\Models\SiteConfigs::task_status($assigned_task->status)}}</td>
                                        <td>
                ...
                <div class="panel-body table-inner table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{\App\Models\SiteConfigs::task_status($completed_task->status)}}</td>
                            <td>
                ...
                <div class="panel-body table-inner table-responsive">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{\App\Models\SiteConfigs::task_status($cancel_task->status)}}</td>
                            <td>
