    ...
    <div class="main_content">
                        ...
                        <div class="objective_content_info">
                            ...
                            <div class="objective_content_info_links">
                                ...
                                <a class="edit_icon watchlist-link-idea" href="javascript:void(0);"
                                    data-id="{{ $idea->id }}" data-auth="{{ $isLoggedIn ? '1' : '0' }}"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="title_col">
                                    ...
                                    <span
                                        class="colorLightGreen">{{\App\Models\SiteConfigs::task_status($idea->task->status)}}</span>
                                    @else
                                    <span
                                        class="colorLightGreen">{{\App\Models\SiteConfigs::task_status($idea->task->status)}}</span>
                                    @endif
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="type_col">
                                    <a href="{!! url('userprofiles/'.$userIDHashID->encode($idea->issue->user_id).'/'.strtolower(str_replace(" ","
        ...
        <div class="content_block_comments">
            ...
            <div class="content_block_bottom">
                ...
                <div class="separator"></div> <a href="{{ url('ideas?unit=' . $unitData->id) }}" class="see_more"
