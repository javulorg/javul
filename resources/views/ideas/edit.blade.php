                                ...
                                <div class="input-icon right">
                                    <select class="form-control selectpicker" data-live-search="true" name="category_id" id="category_id">
                                        ...
                                        @foreach($types as $type)
                                            <option value="{{ $type->id }}" {{ $type->id == $idea->category_id ? 'selected' : '' }}>{{ $type->title  }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 mt-3 form-group">
                                ...
                                <div class="input-icon right">
                                    <select class="form-control selectpicker" data-live-search="true" name="status" id="status">
                                        ...
                                        <option value="1" {{ $idea->status == 1 ? 'selected' : '' }}>Draft</option>
                                        <option value="2" {{ $idea->status == 2 ? 'selected' : '' }}> Assigned to Task</option>
                                        <option value="3" {{ $idea->status == 3 ? 'selected' : '' }}> Implemented</option>
                                    </select>
                                </div>
                            </div>
