...
define('SWEETCAPTCHA_APP_ID', env('SWEETCAPTCHA_APP_ID')); // your application id (change me)
define('SWEETCAPTCHA_KEY', env('SWEETCAPTCHA_KEY')); // your application key (change me)
define('SWEETCAPTCHA_SECRET', env('SWEETCAPTCHA_SECRET')); // your application secret (change me)
define('SWEETCAPTCHA_PUBLIC_URL', public_path('sweetcaptcha.php')); // public http url to this file
